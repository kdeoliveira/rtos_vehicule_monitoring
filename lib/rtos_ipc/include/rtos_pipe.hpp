...
namespace rtos
{
    ...
    /**
     * @brief Creates a new unidirectional data channel with pipes for IPC
     * 
     */
    class PipeManager
    {
     ...
     */
        ...
        /**
         * @brief Reads one buffer line at the time of the pipe up to the sizeof(T)
         * 
        ...
        /**
         * @brief Write sizeof(T) into the pipe
         * 
         * @tparam T object type to be written
         * @param buffer object to be written
        ...
        /**
         * @brief Returns the file descriptors generated by pipe
         * 
         * @return int* array of two integers
         */
